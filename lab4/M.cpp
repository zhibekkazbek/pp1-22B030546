/*M-74501. Spiral. !!!
Return all elements of the matrix in spiral order, given a matrix of nxn elements. 
Numbers start increasing around the corner matrix(a[0][0]) then goes inside up to the middle element making spiral shape.*/
